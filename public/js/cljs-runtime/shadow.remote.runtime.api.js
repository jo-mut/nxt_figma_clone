...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13809 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13809(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13810 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13810(runtime,key,spec);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13833 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13833(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13855 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13855(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13861 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13861(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13784,callback){
var map__13786 = p__13784;
var map__13786__$1 = cljs.core.__destructure_map(map__13786);
var input = map__13786__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13786__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13786__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
